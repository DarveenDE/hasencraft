...
- Tiere: Naturalist, Critters and Companions, Doggy Talents Next, Adorable Hamster Pets, Snuffles, Ribbits, Friends & Foes, Productive Bees, Ecologics, Aquaculture 2, Redomesticate und sechs Animal-Garden-Module.
- Tech: Create mit ausgewaehlten Integrationen, Immersive Engineering, Applied Energistics 2, Applied Mekanistics und Mekanism.
- Magie: Ars Nouveau und Ars Creo.
- Erkundung: Tectonic, Regions Unexplored, Dungeons and Taverns, zehn YUNG-Erweiterungen, Aether, Twilight Forest und Bumblezone.
- Atmosphaere: Distant Horizons, Iris, Complementary Reimagined, Fresh Animations, AmbientSounds und Falling Leaves.

## Vollstaendige Eintraege

| Name | Seite | Datei | Quelle |
|---|---|---|---|
| [EMF] Entity Model Features | `client` | `entity_model_features-3.2.4-1.21-neoforge.jar` | [Modrinth](https://modrinth.com/project/4I1XuqiY) |
| [ETF] Entity Texture Features | `client` | `entity_texture_features_1.21-neoforge-7.1.jar` | [Modrinth](https://modrinth.com/project/BVzZfTc1) |
| Adorable Hamster Pets | `both` | `adorablehamsterpets-3.6.1-1.21.1+neoforge.jar` | [Modrinth](https://modrinth.com/project/LmrhZdK2) |
| Almost Unified | `both` | `almostunified-neoforge-1.21.1-1.4.2.jar` | [Modrinth](https://modrinth.com/project/sdaSaQEz) |
| AmbientSounds | `client` | `AmbientSounds_NEOFORGE_v6.3.8_mc1.21.1.jar` | [Modrinth](https://modrinth.com/project/fM515JnW) |
| Animal Garden - Fennec Fox | `both` | `animalgarden-fennecfox-1.0.1-neoforge-1.21.1-21.1.215.jar` | [Modrinth](https://modrinth.com/project/BRO0Qo3Y) |
| Animal Garden - Harp Seal | `both` | `animalgarden-harpseal-1.0.0-neoforge-1.21.1-21.1.219.jar` | [Modrinth](https://modrinth.com/project/NvaiT3Fr) |
| Animal Garden - Narwhal | `both` | `animalgarden-narwhal-1.0.0-neoforge-1.21.1-21.1.219.jar` | [Modrinth](https://modrinth.com/project/L6u2gHW6) |
| Animal Garden - Owl | `both` | `animalgarden-owl-1.2.2-neoforge-1.21.1-21.1.206.jar` | [Modrinth](https://modrinth.com/project/gMz0rZEq) |
| Animal Garden - Prairie Dog | `both` | `animalgarden-prairiedog-1.0.1-neoforge-1.21.1-21.1.217.jar` | [Modrinth](https://modrinth.com/project/vdm5Eivp) |
| Animal Garden - Sugar Glider | `both` | `animalgarden-sugargilder-1.0.0-neoforge-1.21.1-21.1.214.jar` | [Modrinth](https://modrinth.com/project/WktWffF9) |
| Another Furniture | `both` | `another_furniture-neoforge-4.0.2.jar` | [Modrinth](https://modrinth.com/project/ulloLmqG) |
| AppleSkin | `both` | `appleskin-neoforge-mc1.21-3.0.9.jar` | [Modrinth](https://modrinth.com/project/EsAfCjCV) |
| Applied Energistics 2 | `both` | `appliedenergistics2-19.2.17.jar` | [Modrinth](https://modrinth.com/project/XxWD5pD3) |
| Applied Mekanistics | `both` | `Applied-Mekanistics-1.6.3.jar` | [Modrinth](https://modrinth.com/project/IiATswDj) |
| Aquaculture 2 | `both` | `Aquaculture-1.21.1-2.7.21.jar` | [Modrinth](https://modrinth.com/project/Vl1uNAuy) |
| Aquarius Libs | `both` | `aquariuslibs-1.2.0-neoforge-1.21.1-21.1.217.jar` | [Modrinth](https://modrinth.com/project/KkHnyaL6) |
| Architectury API | `both` | `architectury-13.0.11-neoforge.jar` | CurseForge #419699 |
| Ars Creo | `both` | `ars_creo-1.21.1-5.4.0.jar` | [Modrinth](https://modrinth.com/project/fZ324GMc) |
| Ars Nouveau | `both` | `ars_nouveau-1.21.1-5.13.0.jar` | [Modrinth](https://modrinth.com/project/TKB6INcv) |
| Athena | `client` | `athena-neoforge-1.21.1-4.0.6.jar` | [Modrinth](https://modrinth.com/project/b1ZV3DIJ) |
| Balm | `both` | `balm-neoforge-1.21.1-21.0.64.jar` | [Modrinth](https://modrinth.com/project/MBAkmtvl) |
...
| Create: Bells & Whistles | `both` | `bellsandwhistles-0.4.7-1.21.1.jar` | [Modrinth](https://modrinth.com/project/gJ5afkVv) |
| Create: Central Kitchen | `both` | `create-central-kitchen-2.5.0.jar` | [Modrinth](https://modrinth.com/project/btq68HMO) |
...
| Dynamic FPS | `client` | `dynamic-fps-3.11.4+minecraft-1.21.0-neoforge.jar` | [Modrinth](https://modrinth.com/project/LQ3K71Q1) |
| Easy Anvils | `both` | `EasyAnvils-v21.1.0-1.21.1-NeoForge.jar` | [Modrinth](https://modrinth.com/project/OZBR5JT5) |
...
| FTB XMod Compat | `both` | `ftb-xmod-compat-neoforge-21.1.10.jar` | CurseForge #889915 |
| Fusion (Connected Textures) | `client` | `fusion-1.3.12-neoforge-mc1.21.1.jar` | [Modrinth](https://modrinth.com/project/p19vrgc2) |
| Fzzy Config | `both` | `fzzy_config-0.7.6+1.21+neoforge.jar` | [Modrinth](https://modrinth.com/project/hYykXjDp) |
| Geckolib | `both` | `geckolib-neoforge-1.21.1-4.9.2.jar` | [Modrinth](https://modrinth.com/project/8BmcQJ2H) |
| GuideME | `both` | `guideme-21.1.17.jar` | [Modrinth](https://modrinth.com/project/Ck4E7v7R) |
| Handcrafted | `both` | `handcrafted-neoforge-1.21.1-4.0.3.jar` | [Modrinth](https://modrinth.com/project/pJmCFF0p) |
...
| Macaw's Furniture | `both` | `mcw-furniture-3.4.1-mc1.21.1neoforge.jar` | [Modrinth](https://modrinth.com/project/dtWC90iB) |
| Macaw's Lights and Lamps | `both` | `mcw-lights-1.1.5-mc1.21.1neoforge.jar` | [Modrinth](https://modrinth.com/project/w4an97C2) |
| Macaw's Paths and Pavings | `both` | `mcw-mcwpaths-1.1.1-mc1.21.1neoforge.jar` | [Modrinth](https://modrinth.com/project/VRLhWB91) |
| Macaw's Roofs | `both` | `mcw-roofs-2.3.2-mc1.21.1neoforge.jar` | [Modrinth](https://modrinth.com/project/B8jaH3P1) |
| Macaw's Trapdoors | `both` | `mcw-trapdoors-1.1.5-mc1.21.1neoforge.jar` | [Modrinth](https://modrinth.com/project/n2fvCDlM) |
| Macaw's Windows | `both` | `mcw-mcwwindows-2.4.2-mc1.21.1neoforge.jar` | [Modrinth](https://modrinth.com/project/C7I0BCni) |
| Mekanism | `both` | `Mekanism-1.21.1-10.7.19.85.jar` | [Modrinth](https://modrinth.com/project/Ce6I4WUE) |
| Mekanism Additions | `both` | `MekanismAdditions-1.21.1-10.7.19.85.jar` | [Modrinth](https://modrinth.com/project/a6F3uASn) |
| Mekanism Generators | `both` | `MekanismGenerators-1.21.1-10.7.19.85.jar` | [Modrinth](https://modrinth.com/project/OFVYKsAk) |
| Mekanism Tools | `both` | `MekanismTools-1.21.1-10.7.19.85.jar` | [Modrinth](https://modrinth.com/project/tqQpq1lt) |
| ModernFix | `both` | `modernfix-neoforge-5.27.20+mc1.21.1.jar` | [Modrinth](https://modrinth.com/project/nmDcB62a) |
| Moonlight Lib | `both` | `moonlight-neoforge-1.21.1-3.3.0.jar` | [Modrinth](https://modrinth.com/project/twkfQtEc) |
| Mouse Tweaks | `client` | `MouseTweaks-neoforge-mc1.21-2.26.1.jar` | [Modrinth](https://modrinth.com/project/aC3cM3Vq) |
| Naturalist | `both` | `naturalist-2.0.2-neoforge-1.21.1.jar` | [Modrinth](https://modrinth.com/project/F8BQNPWX) |
| Nature's Compass | `both` | `NaturesCompass-1.21.1-3.4.0-neoforge.jar` | [Modrinth](https://modrinth.com/project/fPetb5Kh) |
| Noisium | `server` | `noisium-neoforge-2.3.0+mc1.21-1.21.1.jar` | [Modrinth](https://modrinth.com/project/KuNKN7d2) |
...
| Puzzles Lib | `both` | `PuzzlesLib-v21.1.52-1.21.1-NeoForge.jar` | [Modrinth](https://modrinth.com/project/QAGBst4M) |
| Rechiseled | `both` | `rechiseled-1.2.5-neoforge-mc1.21.jar` | [Modrinth](https://modrinth.com/project/B0g2vT6l) |
...
| Tectonic | `both` | `tectonic-3.0.26-neoforge-21.1.jar` | [Modrinth](https://modrinth.com/project/lWDHr9jE) |
...
| Xaero's World Map | `both` | `xaeroworldmap-neoforge-1.21.1-1.44.2.jar` | [Modrinth](https://modrinth.com/project/NcUtCpym) |
| YetAnotherConfigLib (YACL) | `both` | `yet_another_config_lib_v3-3.8.2+1.21.1-neoforge.jar` | [Modrinth](https://modrinth.com/project/1eAoo2KR) |
| YUNG's API | `both` | `YungsApi-1.21.1-NeoForge-5.1.6.jar` | [Modrinth](https://modrinth.com/project/Ua7DFN59) |
| YUNG's Better Desert Temples | `server` | `YungsBetterDesertTemples-1.21.1-NeoForge-4.1.5.jar` | [Modrinth](https://modrinth.com/project/XNlO7sBv) |
| YUNG's Better Dungeons | `server` | `YungsBetterDungeons-1.21.1-NeoForge-5.1.4.jar` | [Modrinth](https://modrinth.com/project/o1C1Dkj5) |
| YUNG's Better Jungle Temples | `server` | `YungsBetterJungleTemples-1.21.1-NeoForge-3.1.2.jar` | [Modrinth](https://modrinth.com/project/z9Ve58Ih) |
| YUNG's Better Mineshafts | `server` | `YungsBetterMineshafts-1.21.1-NeoForge-5.1.1.jar` | [Modrinth](https://modrinth.com/project/HjmxVlSr) |
| YUNG's Better Nether Fortresses | `server` | `YungsBetterNetherFortresses-1.21.1-NeoForge-3.1.5.jar` | [Modrinth](https://modrinth.com/project/Z2mXHnxP) |
| YUNG's Better Ocean Monuments | `server` | `YungsBetterOceanMonuments-1.21.1-NeoForge-4.1.2.jar` | [Modrinth](https://modrinth.com/project/3dT9sgt4) |
| YUNG's Better Strongholds | `server` | `YungsBetterStrongholds-1.21.1-NeoForge-5.1.3.jar` | [Modrinth](https://modrinth.com/project/kidLKymU) |
| YUNG's Better Witch Huts | `server` | `YungsBetterWitchHuts-1.21.1-NeoForge-4.1.1.jar` | [Modrinth](https://modrinth.com/project/t5FRdP87) |
| YUNG's Bridges | `server` | `YungsBridges-1.21.1-NeoForge-5.1.1.jar` | [Modrinth](https://modrinth.com/project/Ht4BfYp6) |
| YUNG's Extras | `server` | `YungsExtras-1.21.1-NeoForge-5.1.1.jar` | [Modrinth](https://modrinth.com/project/ZYgyPyfq) |
| Fresh Animations | `client` | `FreshAnimations_v1.10.4.zip` | [Modrinth](https://modrinth.com/project/50dA9Sha) |
| Complementary Shaders - Reimagined | `client` | `ComplementaryReimagined_r5.8.1.zip` | [Modrinth](https://modrinth.com/project/HVnmMxH1) |
